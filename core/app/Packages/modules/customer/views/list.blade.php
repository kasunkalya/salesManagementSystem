		...
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
				<div class="row">
					...
					<div class="col-xs-6 text-right"><a href="{{{url('customer/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Customer Add</button></a></div>
				</div>
      		</div>
          		...
          		<table class="table table-bordered bordered table-striped table-condensed datatable">
	              	<thead>
		                <tr>
							...
							<th rowspan="2" class="text-center" style="font-weight:normal;">Customer Email</th>
							<th rowspan="2" class="text-center" style="font-weight:normal;">Customer Mobile</th>
		                  	<th colspan="3" class="text-center" width="4%" style="font-weight:normal;">Action</th>
		                </tr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('customer/json/list')}}',[],[]);
		...
		table.on('draw.dt',function(){
			...
			$('.type-delete').click(function(e){
				e.preventDefault();
				id = $(this).data('id');
				sweetAlertConfirm('Delete Customer', 'Are you sure?',2, deleteFunc);
			});
		});
	});
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('customer/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
