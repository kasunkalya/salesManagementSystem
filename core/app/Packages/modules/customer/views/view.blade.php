@extends('layouts.master') @section('title','View Product')
@section('css')
<style type="text/css">
          	...
          	<div class="panel-body">
          		...
          		{!!Form::token()!!}                     
                   <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @if($errors->has('customerName')) error @endif" id="customerName" name="customerName" placeholder="Customer Name" required value="{{ $customer[0]->customer_Name}}">
					...
					<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control @if($errors->has('customerEmail')) error @endif" id="customerEmail" name="customerEmail" placeholder="Customer Email" required value="{{ $customer[0]->email}}">
					...
					<div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="tel"  class="form-control @if($errors->has('customerMobile')) error @endif" id="customerMobile" name="customerMobile" placeholder="Customer Mobile" required value="{{ $customer[0]->mobile}}">
                    ...
                    <a href="{{{url('customer/list')}}}"><button type="button" id="update" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</button></a>
	                </div>
            	</form>
          	</div>
        </div>
