	...
	<div class="col-xs-12">
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
				<div class="row">
					<div class="col-xs-6"><strong>Product List</strong></div>
					<div class="col-xs-6 text-right"><a href="{{{url('product/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Product Add</button></a></div>
				</div>
      		</div>
          		...
          		<table class="table table-bordered bordered table-striped table-condensed datatable">
	              	<thead>
		                <tr>
							...
							<th rowspan="2" class="text-center" style="font-weight:normal;">Unit Price</th>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('product/json/list')}}',[],[]);
		...
		table.on('draw.dt',function(){
			...
			$('.type-delete').click(function(e){
				e.preventDefault();
				id = $(this).data('id');
				sweetAlertConfirm('Delete Product', 'Are you sure?',2, deleteFunc);
			});
		});
	});
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('product/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
