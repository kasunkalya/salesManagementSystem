@extends('layouts.master') @section('title','Order List')
@section('css')
<style type="text/css">
	.switch.switch-sm{
		width: 30px;
		...
		<div class="panel panel-bordered">
      		<div class="panel-heading border">
				<div class="row">
					...
					<div class="col-xs-6 text-right"><a href="{{{url('orders/add')}}}"><button class="btn btn-success"><i class="fa fa-plus" style="width: 28px;"></i>Order Add</button></a></div>
				</div>
      		</div>
          		...
          		<table class="table table-bordered bordered table-striped table-condensed datatable">
	              	<thead>
		                <tr>
							  ...
							  <th rowspan="2" class="text-center" style="font-weight:normal;">Order Date</th>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		table = generateTable('.datatable', '{{url('orders/json/list')}}',[],[]);
	 ...
	 */
	function deleteFunc(){
		ajaxRequest( '{{url('orders/delete')}}' , { 'id' : id  }, 'post', handleData);
	}
