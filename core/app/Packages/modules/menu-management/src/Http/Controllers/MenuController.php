...
use Modules\MenuManage\Models\Menu;
		...
		if($request->ajax()){
			...
			foreach ($data as $key => $menu) {
				...
				if(Sentinel::hasAnyAccess($permissions)){
					array_push($dd, '<a href="#" class="blue" onclick="window.location.href=\''.url('menu/edit/'.$menu->id).'\'" data-toggle="tooltip" data-placement="top" title="Edit Menu"><i class="fa fa-pencil"></i></a>');
				}else{
				...
				if(Sentinel::hasAnyAccess($permissions)){
					array_push($dd, '<a href="#" class="red menu-delete" data-id="'.$menu->id.'" data-toggle="tooltip" data-placement="top" title="Delete Menu"><i class="fa fa-trash-o"></i></a>');
				}else{
