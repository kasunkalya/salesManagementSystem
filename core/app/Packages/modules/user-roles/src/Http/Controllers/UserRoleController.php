...
use Modules\UserRoles\Models\UserRole;

use App\Http\Controllers\Controller;
use Modules\UserRoles\Http\Requests\UserRoleRequest;
	...
	*/
	...
	public function add(UserRoleRequest $request)
	{
		...
		DB::transaction(function () use ($to_be_inserted, $request, $permissions, $user, &$status) {
			...
			Sentinel::getRoleRepository()->setModel('Sammy\UserRoles\Models\UserRole');
